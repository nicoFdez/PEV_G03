...
class InfoVuelos {
 ...
 {     
     ...
     TEL[0]= new int[]{10,17,7,7,12,6,17,7,7,12,6,7};
     TEL[0]= new int[]{9,19,8,8,15,5,19,8,8,15,5,5};
     
     SEP[0] = new double[] {1,1.5,2};
     SEP[1] = new double[] {1,1.5,1.5};
     SEP[2] = new double[] {1,1,1};
     
     tipoVuelos = new TiposVuelo[] {TiposVuelo.W,TiposVuelo.W,TiposVuelo.P,
    		 						TiposVuelo.W,TiposVuelo.G,TiposVuelo.G,
    		 						TiposVuelo.W,TiposVuelo.P,TiposVuelo.W,
    		 						TiposVuelo.W,TiposVuelo.G,TiposVuelo.W};
 }
